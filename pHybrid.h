...
void eval(pchrom, struct info_hybrid, int mat[][MAX_OBJ]);
void eval2(pchrom, struct info_hybrid, int mat[][MAX_OBJ]);
void eval3(pchrom, struct info_hybrid, int mat[][MAX_OBJ]);
void eval4(pchrom, struct info_hybrid, int mat[][MAX_OBJ]);

void trepa_colinas(pchrom, struct info_hybrid, int mat[][MAX_OBJ]);
